...
/*1.update job as Software Developer whose name is SMITH*/
update employees
set JOB_ID = 'IT_PROG'
...
update employees
set salary = 10000 and commission_pct = 0.5
where employee_id = 7788;

/*3.update annual salary of all employee.*/
update employees
set salary = 25000;

/*4.update comm to 100 whose commission is null.*/
update employees
...
where hire_date = '1982-01-23';

/*7.delete all employees whose deptno is 10.*/
delete from employees
where department_id = 10;

/*8.update job_id as Software Developer whose name is Michel Roger*/
update employees
set JOB_ID = 'IT_PROG'
where LAST_NAME = 'Rogers';

/*9.update salary and commission_pact whose empid is 157*/
update employees
set salary = 10000 and commission_pct = 0.40
where employee_id = 157;

-- -----------------------------------------------------------------------
/*write a query to find the count of rating for 100 in customer table */
...
/* write a query to find first 3 character of sname from order table*/
select substr(country_name,1,3) from countries;

/*write a query to find length from sname from salesperson*/
select length(country_name) from countries;

/*write a query to find details of customers whoes name is not liu and pereira*/
select * from employees where first_name !='Steven' and first_name !='Alexander';

/*select ucase(first_name) from employees;*/
select ucase(first_name) from employees;

/*SELECT replace(first_name,"L","r"), replace(first_name,"a","o") FROM employees Where first_name like '%l%' or first_name like '%a%' order by first_name ASC;*/
select replace(first_name,'L','r'), replace(first_name,'a','o') from employees where first_name like '%l%'or first_name like '%a%' order by first_name asc;
...
select job_title, first_name, last_name, (employees.salary- jobs.min_salary) 
as diff from employees, jobs 
where employees.job_id = jobs.job_id;
...
UNION
SELECT * FROM (SELECT * FROM employees W order by W.employee_id DESC) AS W1 WHERE W1.employee_ID <=3;
...
WHERE n-1 = (
 ...
 (select * from employees order by employee_id desc Limit 3) order by employee_id asc;
 
 select * from employees 
group by EMPLOYEE_ID
having EMPLOYEE_ID > ((select max(EMPLOYEE_ID) from employees)-3);
select * from employees;
*/
